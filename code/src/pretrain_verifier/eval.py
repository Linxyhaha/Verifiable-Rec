...
def main(
    ...
    val_dataset = Customize_Dataset(train_file=test_data_path, asin2catid_file=asin2catid_file, tokenizer=tokenizer, max_len=512,  sample=sample, category=category, test=True, K = 4)
